...
using GEIIO.Device;
using GEIIO.Device.Connector;
using GEIIO.Protocol;
using GEIIO.Protocol.Filter;
using GEIIO.Service.Connector;
...
namespace TestDeviceDriver
{
    public class DeviceDriver : RunDevice
    {
        ...
        public override void CommunicateStateChanged(GEIIO.Communicate.CommunicateState comState)
        {
            OnDeviceRuningLog("通讯状态改变");
        }

        public override void ChannelStateChanged(GEIIO.Communicate.ChannelState channelState)
        {

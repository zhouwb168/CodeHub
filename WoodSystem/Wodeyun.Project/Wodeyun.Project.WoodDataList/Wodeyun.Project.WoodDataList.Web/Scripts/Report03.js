...
var Events = {
    ...
    GetGrid: function (callback) {
        ...
        Eventer.Grid(grid, Events.Service, 'GetReport03BySearchWithPaging', [startDate, endDate, rowStart, pageSize, supplier, license, key], callback);
    },
    ...
    OnExcel: function () {
        ...
        var callback = function () {
            var SetValueAndStyle = function (cell, row, column) {
                ...
                if (column == 'SampleTime') result = Events.ToDateTime(result);

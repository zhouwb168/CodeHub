<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WoodCropInFactory.aspx.cs" Inherits="Wodeyun.Project.WoodReport.Web.WoodCropInFactory" %>
...
<head>
    ...
    <script src="/Scripts/WoodCropInFactory.js"></script>
</head>
<body>
    <form>
                    ...
                    <table id="Grid" class="easyui-datagrid" fit="true" data-options="singleSelect:true,
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-options="field:'Bang_Time'" width="192px">首磅日期</th>

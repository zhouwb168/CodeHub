...
var Eventer = {
    ...
    Delete: function (unique, table, refresh, buttons, controls) {
    ...
    Save: function (unique, table, refresh, buttons, controls, greenCardNumber) {
        var entity = controls.Get();
        var data = {
            service: table,
            method: 'SaveEntityByOperator',
            args: [JSON.stringify(entity), greenCardNumber]
        };
        var success = function (result) {
            var root = Ajaxer.GetRoot(result);

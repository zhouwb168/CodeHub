<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report07.aspx.cs" Inherits="Wodeyun.Project.GsmReport.Web.Report07" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script src="/Scripts/Report07.js"></script>
  </head>
  <body>
    <form>
        ...
        <tr>
          <td>
            <table id="Grid" class="easyui-datagrid" fit="true" data-options="singleSelect:true,rownumbers:true,pagination:true,pageSize:20,pageList:[15,20,50,Setter.Max],showFooter:true">
                  ...
                  <th data-options="field:'Area'" width="60px">属地</th>

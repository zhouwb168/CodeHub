<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report05.aspx.cs" Inherits="Wodeyun.Project.GsmReport.Web.Report05" %>
        ...
        <tr>
          <td>
            <table id="Grid" class="easyui-datagrid" fit="true" data-options="singleSelect:true,rownumbers:true,pagination:true,pageSize:20,pageList:[15,20,50,Setter.Max],showFooter:true">
		          <thead>
			          <tr>
				          <th data-options="field:'Area'" width="45px">属地</th>

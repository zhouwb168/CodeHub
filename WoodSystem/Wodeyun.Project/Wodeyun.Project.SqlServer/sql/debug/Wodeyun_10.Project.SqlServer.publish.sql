...
CREATE TABLE [dbo].[Function] (
    ...
    [Remark] NVARCHAR (MAX) NULL,
    [State]  INT            NOT NULL,
    CONSTRAINT [PK_Function] PRIMARY KEY CLUSTERED ([Unique] ASC)
);
...
CREATE TABLE [dbo].[GsmArea] (
    ...
    [Remark] NVARCHAR (MAX) NULL,
    [State]  INT            NOT NULL,
    CONSTRAINT [PK_GsmArea] PRIMARY KEY CLUSTERED ([Unique] ASC)
);
...
CREATE TABLE [dbo].[GsmItem] (
    ...
    [Remark]   NVARCHAR (MAX) NULL,
    [State]    INT            NOT NULL,
    CONSTRAINT [PK_GsmItem] PRIMARY KEY CLUSTERED ([Unique] ASC)
);
...
CREATE TABLE [dbo].[GsmLine] (
    ...
    [Remark] NVARCHAR (MAX) NULL,
    [State]  INT            NOT NULL,
    CONSTRAINT [PK_GsmLine] PRIMARY KEY CLUSTERED ([Unique] ASC)
);
...
CREATE TABLE [dbo].[GsmMessage] (
    ...
    [State]  INT            NOT NULL,
    CONSTRAINT [PK_GsmMessage] PRIMARY KEY CLUSTERED ([Unique] ASC)
);
...
CREATE TABLE [dbo].[GsmOrigin] (
    ...
    [Remark] NVARCHAR (MAX) NULL,
    [State]  INT            NOT NULL,
    CONSTRAINT [PK_GsmOrigin] PRIMARY KEY CLUSTERED ([Unique] ASC)
);
...
CREATE TABLE [dbo].[GsmSupplier] (
    ...
    [Remark] NVARCHAR (MAX) NULL,
    [State]  INT            NOT NULL,
    CONSTRAINT [PK_GsmSupplier] PRIMARY KEY CLUSTERED ([Unique] ASC)
);
...
CREATE TABLE [dbo].[GsmTree] (
    ...
    [Remark] NVARCHAR (MAX) NULL,
    [State]  INT            NOT NULL,
    CONSTRAINT [PK_GsmTree] PRIMARY KEY CLUSTERED ([Unique] ASC)
);
...
CREATE TABLE [dbo].[Role] (
    ...
    [Remark] NVARCHAR (MAX) NULL,
    [State]  INT            NOT NULL,
    CONSTRAINT [PK_Role] PRIMARY KEY CLUSTERED ([Unique] ASC)
);
...
CREATE TABLE [dbo].[Service] (
    ...
    [Remark]   NVARCHAR (MAX) NULL,
    [State]    INT            NOT NULL,
    CONSTRAINT [PK_Service] PRIMARY KEY CLUSTERED ([Unique] ASC)
);
...
VALUES(1, 'Service', 'C:\Private\Project\Warehouse\Codes\Wodeyun.Bf\Wodeyun.Bf.Esb\Wodeyun.Bf.Esb.Wrappers\bin\Debug\Wodeyun.Bf.Esb.Wrappers.dll', 'http://localhost:11001/ServiceService.svc', 'Wodeyun.Bf.Esb.Wrappers.ServiceBll', NULL, 0)
INSERT INTO [Service]([Unique], [Name], [Filename], [Url], [Contract], [Remark], [State])
VALUES(2, 'Exchange.Single', 'C:\Private\Project\Warehouse\Codes\Wodeyun.Bf\Wodeyun.Bf.Exchange\Wodeyun.Bf.Exchange.Wrappers\bin\Debug\Wodeyun.Bf.Exchange.Wrappers.dll', 'http://localhost:11002/SingleService.svc', 'Wodeyun.Bf.Exchange.Wrappers.SingleService', NULL, 0)
INSERT INTO [Service]([Unique], [Name], [Filename], [Url], [Contract], [Remark], [State])
VALUES(3, 'Exchange.Multi', 'C:\Private\Project\Warehouse\Codes\Wodeyun.Bf\Wodeyun.Bf.Exchange\Wodeyun.Bf.Exchange.Wrappers\bin\Debug\Wodeyun.Bf.Exchange.Wrappers.dll', 'http://localhost:11002/MultiService.svc', 'Wodeyun.Bf.Exchange.Wrappers.MultiService', NULL, 0)
INSERT INTO [Service]([Unique], [Name], [Filename], [Url], [Contract], [Remark], [State])
VALUES(4, 'Account', 'C:\Private\Project\Warehouse\Codes\Wodeyun.Bf\Wodeyun.Bf.Account\Wodeyun.Bf.Account.Wrappers\bin\Debug\Wodeyun.Bf.Account.Wrappers.dll', 'http://localhost:12001/AccountService.svc', 'Wodeyun.Bf.Account.Wrappers.AccountBll', NULL, 0)

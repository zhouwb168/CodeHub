...
CREATE TABLE [dbo].[tmp_ms_xx_Account] (
    ...
    [State]       INT            NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_Account] PRIMARY KEY CLUSTERED ([Unique] ASC, [State] ASC)
);
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Account] ([Unique], [State], [Role], [Id], [Description], [Remark])
        SELECT   [Unique],
                 [State],
                 [Role],
                 [Id],
...
CREATE TABLE [dbo].[tmp_ms_xx_Function] (
    ...
    [Remark] NVARCHAR (MAX) NULL,
    [State]  INT            NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_Function] PRIMARY KEY CLUSTERED ([Unique] ASC, [State] ASC)
);
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Function] ([Unique], [State], [Parent], [Type], [Order], [No], [Name], [Url], [Remark])
        SELECT   [Unique],
                 [State],
                 [Parent],
                 [Type],
...
CREATE TABLE [dbo].[tmp_ms_xx_GsmArea] (
    ...
    [Remark] NVARCHAR (MAX) NULL,
    [State]  INT            NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_GsmArea] PRIMARY KEY CLUSTERED ([Unique] ASC, [State] ASC)
);
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_GsmArea] ([Unique], [State], [Name], [Alias], [Remark])
        SELECT   [Unique],
                 [State],
                 [Name],
                 [Alias],
...
CREATE TABLE [dbo].[tmp_ms_xx_GsmItem] (
    ...
    [Remark]   NVARCHAR (MAX) NULL,
    [State]    INT            NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_GsmItem] PRIMARY KEY CLUSTERED ([Unique] ASC, [State] ASC)
);
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_GsmItem] ([Unique], [State], [Message], [Supplier], [Tree], [Make], [Origin], [License], [Mobile], [Ship], [Line], [Remark])
        SELECT   [Unique],
                 [State],
                 [Message],
                 [Supplier],
...
CREATE TABLE [dbo].[tmp_ms_xx_GsmLine] (
    ...
    [Remark] NVARCHAR (MAX) NULL,
    [State]  INT            NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_GsmLine] PRIMARY KEY CLUSTERED ([Unique] ASC, [State] ASC)
);
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_GsmLine] ([Unique], [State], [Name], [Alias], [Remark])
        SELECT   [Unique],
                 [State],
                 [Name],
                 [Alias],
...
CREATE TABLE [dbo].[tmp_ms_xx_GsmMessage] (
    ...
    [State]  INT            NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_GsmMessage] PRIMARY KEY CLUSTERED ([Unique] ASC, [State] ASC)
);
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_GsmMessage] ([Unique], [State], [Mobile], [Date], [Text])
        SELECT   [Unique],
                 [State],
                 [Mobile],
                 [Date],
...
CREATE TABLE [dbo].[tmp_ms_xx_GsmOrigin] (
    ...
    [Remark] NVARCHAR (MAX) NULL,
    [State]  INT            NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_GsmOrigin] PRIMARY KEY CLUSTERED ([Unique] ASC, [State] ASC)
);
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_GsmOrigin] ([Unique], [State], [Area], [Name], [Alias], [Remark])
        SELECT   [Unique],
                 [State],
                 [Area],
                 [Name],
...
CREATE TABLE [dbo].[tmp_ms_xx_GsmSupplier] (
    ...
    [Remark] NVARCHAR (MAX) NULL,
    [State]  INT            NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_GsmSupplier] PRIMARY KEY CLUSTERED ([Unique] ASC, [State] ASC)
);
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_GsmSupplier] ([Unique], [State], [Type], [Name], [Remark])
        SELECT   [Unique],
                 [State],
                 [Type],
                 [Name],
...
CREATE TABLE [dbo].[tmp_ms_xx_GsmTree] (
    ...
    [Remark] NVARCHAR (MAX) NULL,
    [State]  INT            NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_GsmTree] PRIMARY KEY CLUSTERED ([Unique] ASC, [State] ASC)
);
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_GsmTree] ([Unique], [State], [Name], [Alias], [Remark])
        SELECT   [Unique],
                 [State],
                 [Name],
                 [Alias],
...
CREATE TABLE [dbo].[tmp_ms_xx_Link] (
    ...
    [Remark] NVARCHAR (MAX) NULL,
    [State]  INT            NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_Link] PRIMARY KEY CLUSTERED ([Unique] ASC, [State] ASC)
);
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Link] ([Unique], [State], [Name], [Url], [Remark])
        SELECT   [Unique],
                 [State],
                 [Name],
                 [Url],
...
CREATE TABLE [dbo].[tmp_ms_xx_Role] (
    ...
    [Remark] NVARCHAR (MAX) NULL,
    [State]  INT            NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_Role] PRIMARY KEY CLUSTERED ([Unique] ASC, [State] ASC)
);
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Role] ([Unique], [State], [Name], [Remark])
        SELECT   [Unique],
                 [State],
                 [Name],
                 [Remark]
...
CREATE TABLE [dbo].[tmp_ms_xx_Service] (
    ...
    [Remark]   NVARCHAR (MAX) NULL,
    [State]    INT            NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_Service] PRIMARY KEY CLUSTERED ([Unique] ASC, [State] ASC)
);
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Service] ([Unique], [State], [Name], [Filename], [Url], [Contract], [Remark])
        SELECT   [Unique],
                 [State],
                 [Name],
                 [Filename],
...
CREATE TABLE [dbo].[tmp_ms_xx_Verificate] (
    ...
    [Remark]  NVARCHAR (MAX) NULL,
    [State]   INT            NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_Verificate] PRIMARY KEY CLUSTERED ([Unique] ASC, [State] ASC)
);
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Verificate] ([Unique], [State], [Account], [Link], [Value], [Remark])
        SELECT   [Unique],
                 [State],
                 [Account],
                 [Link],

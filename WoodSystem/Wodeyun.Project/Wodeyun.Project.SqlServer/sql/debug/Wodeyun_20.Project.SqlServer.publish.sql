...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_GsmMessage] ([Unique], [Version], [Parent], [Mobile], [Date], [Text], [Remark], [State])
        SELECT   [Unique],
                 [Version],
                 [Parent],
                 [Mobile],
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Link] ([Unique], [Version], [Name], [Remark], [State])
        SELECT   [Unique],
                 [Version],
                 [Name],
                 [Remark],

...
GO
PRINT N'正在创建 [dbo].[Esb]...';


GO
CREATE TABLE [dbo].[Esb] (
    [Unique]   INT            NOT NULL,
    ...
    [State]    INT            NOT NULL,
    CONSTRAINT [PK_Esb] PRIMARY KEY CLUSTERED ([Unique] ASC)
);


GO
PRINT N'正在创建 [dbo].[Esb].[IX_Esb]...';


GO
CREATE NONCLUSTERED INDEX [IX_Esb]
    ON [dbo].[Esb]([Service] ASC);

...
GO
/*
必须添加表 [dbo].[Account] 中的列 [dbo].[Account].[Log]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[Account] 中的列 [dbo].[Account].[Operator]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[Account] 中的列 [dbo].[Account].[Status]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。
*/
...
GO
/*
必须添加表 [dbo].[Act] 中的列 [dbo].[Act].[Log]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[Act] 中的列 [dbo].[Act].[Operator]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。
*/

IF EXISTS (select top 1 1 from [dbo].[Act])
    RAISERROR (N'检测到行。由于可能丢失数据，正在终止架构更新。', 16, 127) WITH NOWAIT

GO
/*
必须添加表 [dbo].[Function] 中的列 [dbo].[Function].[Log]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[Function] 中的列 [dbo].[Function].[Operator]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。
*/
...
GO
/*
必须添加表 [dbo].[Grant] 中的列 [dbo].[Grant].[Log]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[Grant] 中的列 [dbo].[Grant].[Operator]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。
*/
...
GO
/*
必须添加表 [dbo].[GsmArea] 中的列 [dbo].[GsmArea].[Log]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[GsmArea] 中的列 [dbo].[GsmArea].[Operator]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。
*/
...
GO
/*
必须添加表 [dbo].[GsmItem] 中的列 [dbo].[GsmItem].[Log]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[GsmItem] 中的列 [dbo].[GsmItem].[Operator]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。
*/
...
GO
/*
必须添加表 [dbo].[GsmLine] 中的列 [dbo].[GsmLine].[Log]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[GsmLine] 中的列 [dbo].[GsmLine].[Operator]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。
*/
...
GO
/*
必须添加表 [dbo].[GsmMessage] 中的列 [dbo].[GsmMessage].[Log]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[GsmMessage] 中的列 [dbo].[GsmMessage].[Operator]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。
*/
...
GO
/*
必须添加表 [dbo].[GsmOrigin] 中的列 [dbo].[GsmOrigin].[Log]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[GsmOrigin] 中的列 [dbo].[GsmOrigin].[Operator]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。
*/
...
GO
/*
必须添加表 [dbo].[GsmSupplier] 中的列 [dbo].[GsmSupplier].[Log]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[GsmSupplier] 中的列 [dbo].[GsmSupplier].[Operator]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。
*/
...
GO
/*
必须添加表 [dbo].[GsmTree] 中的列 [dbo].[GsmTree].[Log]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[GsmTree] 中的列 [dbo].[GsmTree].[Operator]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。
*/
...
GO
/*
必须添加表 [dbo].[Link] 中的列 [dbo].[Link].[Log]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[Link] 中的列 [dbo].[Link].[Operator]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。
*/
...
GO
/*
必须添加表 [dbo].[Role] 中的列 [dbo].[Role].[Log]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[Role] 中的列 [dbo].[Role].[Operator]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。
*/
...
GO
/*
必须添加表 [dbo].[Service] 中的列 [dbo].[Service].[Log]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[Service] 中的列 [dbo].[Service].[Operator]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。
*/
...
GO
/*
必须添加表 [dbo].[Verificate] 中的列 [dbo].[Verificate].[Log]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。

必须添加表 [dbo].[Verificate] 中的列 [dbo].[Verificate].[Operator]，但该列无默认值，也不允许使用 NULL 值。如果表中包含数据，ALTER 脚本将不能工作。为避免此问题，必须: 向该列添加默认值，或者将其标记为允许使用 NULL 值，或者启用智能默认值生成功能作为部署选项。
*/
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Account] ([Unique], [Version], [Id], [Description], [Remark], [State])
        SELECT   [Unique],
                 [Version],
                 [Id],
                 [Description],
...
GO
PRINT N'正在改变 [dbo].[Act]...';


GO
ALTER TABLE [dbo].[Act]
    ADD [Operator] INT            NOT NULL,
        [Log]      NVARCHAR (MAX) NOT NULL;


GO
PRINT N'正在改变 [dbo].[Function]...';
...
GO
ALTER TABLE [dbo].[GsmItem]
    ADD [Operator] INT            NOT NULL,
        [Log]      NVARCHAR (MAX) NOT NULL;


GO
PRINT N'正在改变 [dbo].[GsmLine]...';
...
GO
PRINT N'正在改变 [dbo].[GsmMessage]...';


GO
ALTER TABLE [dbo].[GsmMessage]
    ADD [Operator] INT            NOT NULL,
        [Log]      NVARCHAR (MAX) NOT NULL;


GO
PRINT N'正在改变 [dbo].[GsmOrigin]...';


GO
ALTER TABLE [dbo].[GsmOrigin]
    ADD [Operator] INT            NOT NULL,
        [Log]      NVARCHAR (MAX) NOT NULL;
...
GO
ALTER TABLE [dbo].[GsmSupplier]
    ADD [Operator] INT            NOT NULL,
        [Log]      NVARCHAR (MAX) NOT NULL;


GO
PRINT N'正在改变 [dbo].[GsmTree]...';
...
GO
PRINT N'正在改变 [dbo].[Verificate]...';


GO
ALTER TABLE [dbo].[Verificate]
    ADD [Operator] INT            NOT NULL,
        [Log]      NVARCHAR (MAX) NOT NULL;
...
INSERT INTO [Account]([Unique], [Id], [Description], [Remark], [State], [Version], [Operator], [Log])
VALUES(1, 'zdq', '{"Department":"慧云公司","Name":"张德强","Mobile":"13570067306","Email":"zdq@tcloudit.com"}', NULL, 0, 1, 1, '{"Date":"2013-04-01 00:00:00"}')
...
INSERT INTO [GsmArea] ([Unique], [Name], [Remark], [State], [Version], [Operator], [Log]) VALUES (6, '大化县', NULL, 0, 1, 1, '{"Date":"2013-04-01 00:00:00"}')
...
INSERT INTO [GsmOrigin] ([Unique], [Area], [Name], [Alias], [Except], [Remark], [State], [Version], [Operator], [Log]) VALUES (33, 5, '云南', '云南', '富宁; 者桑; 红森', NULL, 0, 1, 1, '{"Date":"2013-04-01 00:00:00"}')

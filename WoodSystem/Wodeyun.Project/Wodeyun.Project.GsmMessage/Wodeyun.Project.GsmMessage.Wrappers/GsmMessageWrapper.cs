...
namespace Wodeyun.Project.GsmMessage.Wrappers
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="Wodeyun.Project.GsmMessage.Wrappers.IGsmMessageInterface")]
    public interface IGsmMessageInterface
    {
        ...
        [System.ServiceModel.Web.WebInvoke(BodyStyle = System.ServiceModel.Web.WebMessageBodyStyle.Wrapped)]
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGsmMessageInterface/GetEntitiesWithSupplierNameByDateAndSuppl" +
            "ierAndMobileAndStartAndLength", ReplyAction="http://tempuri.org/IGsmMessageInterface/GetEntitiesWithSupplierNameByDateAndSuppl" +
            "ierAndMobileAndStartAndLengthResponse")]
        Wodeyun.Gf.Entities.EntityCollection GetEntitiesWithSupplierNameByDateAndSupplierAndMobileAndStartAndLength(string date, string supplier, string mobile, int start, int length);
        
        [System.ServiceModel.Web.WebInvoke(BodyStyle = System.ServiceModel.Web.WebMessageBodyStyle.Wrapped)]
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGsmMessageInterface/GetItemsByText", ReplyAction="http://tempuri.org/IGsmMessageInterface/GetItemsByTextResponse")]
        Wodeyun.Gf.Entities.EntityCollection GetItemsByText(string text);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IGsmMessageInterfaceChannel : Wodeyun.Project.GsmMessage.Wrappers.IGsmMessageInterface, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class GsmMessageInterfaceClient : System.ServiceModel.ClientBase<Wodeyun.Project.GsmMessage.Wrappers.IGsmMessageInterface>, Wodeyun.Project.GsmMessage.Wrappers.IGsmMessageInterface
    {
        
        public GsmMessageInterfaceClient()
        {
        }
        
        public GsmMessageInterfaceClient(string endpointConfigurationName) : 
                base(endpointConfigurationName)
        {
        }
        
        public GsmMessageInterfaceClient(string endpointConfigurationName, string remoteAddress) : 
                base(endpointConfigurationName, remoteAddress)
        {
        }
        
        public GsmMessageInterfaceClient(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(endpointConfigurationName, remoteAddress)
        {
        }
        
        public GsmMessageInterfaceClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
        ...
        public Wodeyun.Gf.Entities.EntityCollection GetEntitiesWithSupplierNameByDateAndSupplierAndMobileAndStartAndLength(string date, string supplier, string mobile, int start, int length)
        {
            return base.Channel.GetEntitiesWithSupplierNameByDateAndSupplierAndMobileAndStartAndLength(date, supplier, mobile, start, length);
        }
        
        public Wodeyun.Gf.Entities.EntityCollection GetItemsByText(string text)
        {
            return base.Channel.GetItemsByText(text);
        }
    }
}

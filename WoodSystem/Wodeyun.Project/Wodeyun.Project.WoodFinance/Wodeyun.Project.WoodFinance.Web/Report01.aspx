<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report01.aspx.cs" Inherits="Wodeyun.Project.WoodFinance.Web.Report01" %>
        ...
        <tr>
          <td>
            <table id="Grid" class="easyui-datagrid" fit="true" data-options="singleSelect:true,rownumbers:true,pagination:true,pageSize:15,pageList:[15,50,Setter.Max]">
		          <thead>
			          <tr>
				          <th data-options="field:'WeighTime'" width="100px">首磅时间</th>
                  <th data-options="field:'UnLoadPeople'" width="324px">卸车员</th>
                  <th data-options="field:'jWeight'" width="100px">卸木片（吨）</th>
                  <th data-options="field:'License'" width="100px">车号</th>
                  <th data-options="field:'Tree'" width="70px">片种</th>
                  <th data-options="field:'UnLoadPalce'" width="70px">卸货地点</th>
			          </tr>
		          </thead>
	          </table>
          </td>

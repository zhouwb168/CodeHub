...
namespace Wodeyun.Project.WoodFinance.Wrappers
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="Wodeyun.Project.WoodFinance.Wrappers.IWoodFinanceInterface")]
    public interface IWoodFinanceInterface
    {
        ...
        [System.ServiceModel.Web.WebInvoke(BodyStyle = System.ServiceModel.Web.WebMessageBodyStyle.Wrapped)]
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWoodFinanceInterface/GetReport02BySearchWithPaging", ReplyAction="http://tempuri.org/IWoodFinanceInterface/GetReport02BySearchWithPagingResponse")]
        Wodeyun.Gf.Entities.EntityCollection GetReport02BySearchWithPaging(string startDate, string endDate, int start, int length, string people);
        
        [System.ServiceModel.Web.WebInvoke(BodyStyle = System.ServiceModel.Web.WebMessageBodyStyle.Wrapped)]
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWoodFinanceInterface/GetReport01BySearchWithPaging", ReplyAction="http://tempuri.org/IWoodFinanceInterface/GetReport01BySearchWithPagingResponse")]
        Wodeyun.Gf.Entities.EntityCollection GetReport01BySearchWithPaging(string startDate, string endDate, int start, int length, string people);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IWoodFinanceInterfaceChannel : Wodeyun.Project.WoodFinance.Wrappers.IWoodFinanceInterface, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WoodFinanceInterfaceClient : System.ServiceModel.ClientBase<Wodeyun.Project.WoodFinance.Wrappers.IWoodFinanceInterface>, Wodeyun.Project.WoodFinance.Wrappers.IWoodFinanceInterface
    {
        
        public WoodFinanceInterfaceClient()
        {
        }
        
        public WoodFinanceInterfaceClient(string endpointConfigurationName) : 
                base(endpointConfigurationName)
        {
        }
        
        public WoodFinanceInterfaceClient(string endpointConfigurationName, string remoteAddress) : 
                base(endpointConfigurationName, remoteAddress)
        {
        }
        
        public WoodFinanceInterfaceClient(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(endpointConfigurationName, remoteAddress)
        {
        }
        
        public WoodFinanceInterfaceClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
        ...
        public Wodeyun.Gf.Entities.EntityCollection GetReport02BySearchWithPaging(string startDate, string endDate, int start, int length, string people)
        {
            return base.Channel.GetReport02BySearchWithPaging(startDate, endDate, start, length, people);
        }
        
        public Wodeyun.Gf.Entities.EntityCollection GetReport01BySearchWithPaging(string startDate, string endDate, int start, int length, string people)
        {
            return base.Channel.GetReport01BySearchWithPaging(startDate, endDate, start, length, people);
        }
    }
}

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Wodeyun.Project.GsmArea.Web.Index" %>

<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>Wodeyun Project GsmArea</title>
        ...
        <tr>
          ...
          <td width="400px" style="vertical-align:top">
            <table width="100%">
              ...
              <tr>
                <td style="display:none;"><input id="Unique" type="text" title="序号" value="0" /></td>
              </tr>
            </table>
            <table width="100%">
              <tr>

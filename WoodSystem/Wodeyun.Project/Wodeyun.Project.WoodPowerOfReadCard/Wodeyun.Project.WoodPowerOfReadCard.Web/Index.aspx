<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Wodeyun.Bf.WoodPowerOfReadCard.Web.Index" %>

<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>Wodeyun Bf WoodPowerOfReadCard</title>
              ...
              <tr>
                <td class="Td" height="100%">
                  <table id="Power" class="easyui-datagrid" fit="true" data-options="singleSelect:true,rownumbers:true,idField:'Unique'">
                        ...
                        <th data-options="field:'Name'" width="326">平板相机名称</th>
			                </tr>
		                </thead>
	                </table>
                </td>

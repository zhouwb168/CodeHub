...
using Wodeyun.Project.WoodPowerOfGps.Dals;
using Wodeyun.Project.WoodPowerOfGps.Interfaces;
using Wodeyun.Gf.Entities;
using Wodeyun.Gf.System.Utilities;

namespace Wodeyun.Project.WoodPowerOfGps.Blls
{
    [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
    public class WoodPowerOfGpsBll : CommonBll, IWoodPowerOfGpsInterface
    {
        private WoodPowerOfGpsDal _Dal = new WoodPowerOfGpsDal();

        public WoodPowerOfGpsBll()
        {
            this.Dal = this._Dal;
        }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Wodeyun.Bf.WoodMachine.Web.Index" %>

<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>Wodeyun Project WoodMachine</title>
        ...
        <tr>
          <td width="400px" class="Td" style="vertical-align:top">
            <table id="Grid" class="easyui-datagrid" fit="true" data-options="singleSelect:true,rownumbers:true,pagination:true,pageSize:20">
		          <thead>
			          <tr>
				          <th data-options="field:'Name'" width="371px">平板电脑名称</th>
			          </tr>
		          </thead>
	          </table>
          </td>
          <td width="400px" style="vertical-align:top">
            ...
            <table width="100%">
              <tr>
                <td width="25%" class="Td">平板电脑名称：</td>
                <td width="75%" class="Td"><input id="txtName" type="text" class="easyui-validatebox" disabled="disabled" style="width:180px" data-options="required:true" maxlength="50" /> ( 如：平板电脑A )</td>
              </tr>
              <tr>
                <td class="Td">唯一识别码：</td>
                <td class="Td"><input id="txtMachineNumber" type="text" class="easyui-validatebox" disabled="disabled" style="width:100%" data-options="required:true" /></td>
              </tr>
              <tr>
                <td class="Td">&nbsp;</td>
                <td class="Td-Combo">
              ...
              <tr>
                ...
                <td class="Td-Combo">
                  请为每一台平板电脑设定好名称和设备本身的唯一识别码。
                  <br /><br />以便于分配平板电脑权限时指定哪些用户可以使用该平板电脑进行拍照操作和读卡操作。
                  <br /><br />唯一识别码请使用平板电脑自身带有的唯一识别码。
                </td>
              </tr>
            </table>
          </td>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Wodeyun.Bf.Grant.Web.Index" %>

<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>Wodeyun Bf Grant</title>
            ...
            <table width="100%" height="100%">
              ...
              <tr>
                <td class="Td" height="100%">
                  <table id="Function" class="easyui-treegrid" fit="true" data-options="singleSelect:false,rownumbers:true,idField:'Unique',treeField:'Name'">
		                <thead>
			                <tr>
				                <th data-options="checkbox:true"></th>
                        <th data-options="field:'Name'" width="326">名称</th>
			                </tr>
		                </thead>
	                </table>
                </td>

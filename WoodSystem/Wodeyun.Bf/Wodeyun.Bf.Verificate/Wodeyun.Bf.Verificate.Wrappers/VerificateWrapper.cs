...
namespace Wodeyun.Bf.Verificate.Wrappers
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="Wodeyun.Bf.Verificate.Wrappers.IVerificateInterface")]
    public interface IVerificateInterface
    {
        ...
        [System.ServiceModel.Web.WebInvoke(BodyStyle = System.ServiceModel.Web.WebMessageBodyStyle.Wrapped)]
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IVerificateInterface/GetEntityByLinkAndUsernameAndPassword", ReplyAction="http://tempuri.org/IVerificateInterface/GetEntityByLinkAndUsernameAndPasswordResp" +
            "onse")]
        Wodeyun.Gf.Entities.Entity GetEntityByLinkAndUsernameAndPassword(int link, string username, string password);
        
        [System.ServiceModel.Web.WebInvoke(BodyStyle = System.ServiceModel.Web.WebMessageBodyStyle.Wrapped)]
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IVerificateInterface/GetEntitiesWithAccountAndLinkNameByStartA" +
            "ndLength", ReplyAction="http://tempuri.org/IVerificateInterface/GetEntitiesWithAccountAndLinkNameByStartA" +
            "ndLengthResponse")]
        Wodeyun.Gf.Entities.EntityCollection GetEntitiesWithAccountAndLinkNameByStartAndLength(int start, int length);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IVerificateInterfaceChannel : Wodeyun.Bf.Verificate.Wrappers.IVerificateInterface, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class VerificateInterfaceClient : System.ServiceModel.ClientBase<Wodeyun.Bf.Verificate.Wrappers.IVerificateInterface>, Wodeyun.Bf.Verificate.Wrappers.IVerificateInterface
    {
        
        public VerificateInterfaceClient()
        {
        }
        
        public VerificateInterfaceClient(string endpointConfigurationName) : 
                base(endpointConfigurationName)
        {
        }
        
        public VerificateInterfaceClient(string endpointConfigurationName, string remoteAddress) : 
                base(endpointConfigurationName, remoteAddress)
        {
        }
        
        public VerificateInterfaceClient(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(endpointConfigurationName, remoteAddress)
        {
        }
        
        public VerificateInterfaceClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
        ...
        public Wodeyun.Gf.Entities.Entity GetEntityByLinkAndUsernameAndPassword(int link, string username, string password)
        {
            return base.Channel.GetEntityByLinkAndUsernameAndPassword(link, username, password);
        }
        
        public Wodeyun.Gf.Entities.EntityCollection GetEntitiesWithAccountAndLinkNameByStartAndLength(int start, int length)
        {
            return base.Channel.GetEntitiesWithAccountAndLinkNameByStartAndLength(start, length);
        }
    }
}

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Wodeyun.Bf.Role.Web.Index" %>

<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>Wodeyun Bf Role</title>
          ...
          <td width="400px" style="vertical-align:top">
            ...
            <table width="100%">
              <tr>
                ...
                <td width="75%" class="Td"><input id="Name" type="text" disabled class="easyui-validatebox" style="width:100%" data-options="required:true" /></td>
              </tr>
              <tr>
                <td class="Td">备注：</td>
